...
def stochastinis_gradientinis_nusileidimas(mokymo_pozymiai, mokymo_klase, mokymosi_greitis=0.05, epochos=10000, mokymo_riba=1e-6, validavimo_pozymiai=None, validavimo_klase=None):
    ...
    while totalError > mokymo_riba and epocha < epochos:
        ...
        for i in range(m):
            ...
            for k in range(n):
                svoriai[k] -= mokymosi_greitis * (yi - ti) * yi * (1 - yi) * mokymo_pozymiai[i, k]
...
def main():
    ...
    svoriai, poslinkis, mokymo_totalErrors_grafikui, validavimo_totalErrors_grafikui, mokymo_tikslumas_grafikui, validavimo_tikslumas_grafikui = stochastinis_gradientinis_nusileidimas(
    ...
    stochastinio_gradientinio_nusileidimo_grafikai(range(epochos), mokymo_totalErrors_grafikui, validavimo_totalErrors_grafikui, mokymo_tikslumas_grafikui, validavimo_tikslumas_grafikui)
